...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FmdWk0ayIsImEiOiJja3lwNWZhazgwNnVtMnVtZDlpMzV6NXNiIn0.nSnKszWi7fKj42-NNLUznA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kafui4k/ckyp760ivn4dj15nuur097wsm' //   center: [342.232, -23.2309293],
    //   zoom: 10,
    //   interactive: false
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert laert--".concat(type, "\">").concat(msg, "</div>");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updaMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.default)('success', "".concat(type.toUpperCase()), 'Data Updated successfully');
            }
...
var userDataForm = document.querySelector.apply('.form-user-data');
var userPasswordForm = document.querySelector.apply('.form-user-password'); // VALUES
// DELEGATION
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6582" + '/');
