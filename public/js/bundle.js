...
})(
  {
      ...
      function(require, module, exports) {
        ...
        (a.prototype.request = function(t, e) {
          ...
          if (
            ...
            var f = [o, void 0];
            for (
              Array.prototype.unshift.apply(f, a),
                f = f.concat(l),
                h = Promise.resolve(e);
              f.length;
          ...
          for (; l.length; ) h = h.then(l.shift(), l.shift());
          return h;
        }),
                  ...
                  for (;;)
                    switch ((r.prev = r.next)) {
                      ...
                      case 7:
                        (r.prev = 7),
                          (r.t0 = r.catch(0)),
                          (0, t.showAlert)('err', r.t0.response.data.message);
                      case 10:
                      case 'end':
                        return r.stop();
                    }
                ...
                function(r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      ...
                      case 3:
                        (r.sent.data.status = 'success') && location.reload(!0),
                          (r.next = 10);
                        break;
                      case 7:
                        (r.prev = 7),
    ...
    FxPS: [
      function(require, module, exports) {
        ...
        var s = (function() {
          var r = n(
            regeneratorRuntime.mark(function r(a, n) {
              var s;
              return regeneratorRuntime.wrap(
                function(r) {
                  for (;;)
                    switch ((r.prev = r.next)) {
                      case 0:
                        return (
                          ...
                          (s =
                            'password' === n
                              ? 'http://127.0.0.1:3000/api/v1/users/updaMyPassword'
                              : 'http://127.0.0.1:3000/api/v1/users/updateMe'),
                          (r.next = 4),
                          (0, e.default)({ method: 'PATCH', url: s, data: a })
                        );
                      case 4:
                        'success' === r.sent.data.status &&
                          (0, t.default)(
                      ...
                      case 8:
                        (r.prev = 8),
                          (r.t0 = r.catch(0)),
                          (0, t.default)('error', r.t0.response.data.message);
                      case 11:
                      case 'end':
                        return r.stop();
                    }
